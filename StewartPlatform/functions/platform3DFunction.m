function [ q_prime, Fr, L_vector ] = platform3DFunction(t,q,Prm,F,F_load,des_case)

Generated_R = Generate_R(q(4),q(5),q(6));
TP = Prm.TP;
TP_Current = [ Generate_R(q(4),q(5),q(6)), [q(1);q(2);q(3)] ] * TP;
...
[F1 F2 F3 F4 F5 F6] = deal(F(1),F(2),F(3),F(4),F(5),F(6));
